...
namespace Modules\ModuleSpanishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Spanish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Spanish UI translations from Messages/es/ directory
 * - Spanish voice prompts from Sounds/es-es/ directory
 *
 ...
 *
 * @package Modules\ModuleSpanishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleSpanishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Spanish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Spanish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Spanish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Spanish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Spanish Language Pack uninstalled successfully',
            LOG_INFO
        );
